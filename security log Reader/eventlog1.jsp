...
String sql ="select * from eventlog where EventRecordID<" + evtid + " ORDER BY EventRecordID DESC";
String recid = evtid;
...
<form class="container w-25 text-center" style="margin-top: 100px;" action="eventlog1.jsp" method="get"><button type="submit" name="evtid" value=<%=recid %>>Back</button></form>
<%
} catch (Exception e) {
e.printStackTrace();
}
